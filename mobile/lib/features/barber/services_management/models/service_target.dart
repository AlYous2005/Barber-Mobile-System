...
extension ServiceTargetX on ServiceTarget {
  ...
  static ServiceTarget fromDatabaseValue(String? value) {
    switch (value) {
      case 'child':
        return ServiceTarget.child;
      case 'elderly':
        return ServiceTarget.elderly;
      case 'personal':
      default:
        return ServiceTarget.personal;
    }
  }
}

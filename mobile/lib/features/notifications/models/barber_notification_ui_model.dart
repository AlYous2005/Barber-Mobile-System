...
class UiNotification {
  ...
  factory UiNotification.fromAppNotification(AppNotification notification) {
    return UiNotification(
      id: notification.id,
...
NotificationType notificationTypeFromDatabase(String value) {
  switch (value) {
    ...
    case 'customer_access_request':
      return NotificationType.customerAccessRequest;

    case 'customer_access_response':
      return NotificationType.customerAccessResponse;

    case NotificationTypes.service:
      return NotificationType.service;

    case NotificationTypes.workingHours:
      return NotificationType.workingHours;

    case NotificationTypes.availability:
